...
= MuleChain Module Documentation Reference
...
| Anypoint Url a| String |  |  | *x*{nbsp}
| Anypoint Client Id a| String |  |  | *x*{nbsp}
| Anypoint Client Secret a| String |  |  | *x*{nbsp}
...
* <<Add-file-to-embedding-store>> {nbsp}
* <<Answer-prompt>> {nbsp}
* <<Define-prompt-template>> {nbsp}
* <<Generate-image>> {nbsp}
* <<Get-info-from-embedding-store>> {nbsp}
...
* <<Use-tools-dynamically>> {nbsp}



== Operations

[[Add-file-to-embedding-store]]
=== Add File To Embedding Store
`<mulechain:add-file-to-embedding-store>`
...
=== Define Prompt Template
`<mulechain:define-prompt-template>`
...
[[Get-info-from-embedding-store]]
=== Get Info From Embedding Store
`<mulechain:get-info-from-embedding-store>`
...
=== Load Document From Url
`<mulechain:load-document-from-url>`
...
=== Load Document Pdf File
`<mulechain:load-document-pdf-file>`
...
=== Load Document Txt File
`<mulechain:load-document-txt-file>`
...
=== Use Tools Dynamically
`<mulechain:use-tools-dynamically>`
